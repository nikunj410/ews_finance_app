...
(
  ...
  (
   ...
   (
    ...
    (
     tabPanel("DJI",
      fluidRow
      ( 
       column(7,img(src="dji.jpg", height = 700, width = 525, align = "center")),
     ...
     tabPanel("S&P500",
      fluidRow
      ( 
       column(7,img(src="sp500.jpg", height = 700, width = 425, align = "center")),
     ...
     tabPanel("NASDAQ",
      fluidRow
      ( 
       column(7,img(src="nasdaq.jpg", height = 700, width = 425, align = "center")),
     ...
     tabPanel("DAX and FTSE",
      fluidRow
      ( 
       column(7,img(src="dax&ftse.jpg", height = 700, width = 525, align = "center")),
   ...
   tabPanel
   ("Current Trends",
    # titlePanel("Current Early Warning Signals"),
    ...
    (     
     textOutput("Alert"),
    tags$head(tags$style("#Alert{color: brown;
                                 font-size: 20px;
                         font-style: Ariel;
                         }"
                         )),
              
     plotOutput("ews_current", width = "100%")
    )
   ...
   ("Analyse Yourself",  
    ...
    fluidRow(
     column(4,
      ...
      helpText("We recommend a minimum of 4 years as the time range between the input dates.",
               "We use the last four years as default time range."
              ),
      dateRangeInput
      ("daterange", "",start  = Sys.Date() - years(4), end    = Sys.Date(),
                    max    = Sys.Date(), format = "dd M yyyy", separator = " to ", width = 440),
      ...
      (
       ...
       (
        ...
        sliderInput
        ("rw", "Rolling window (l_rw)", min = 400, max = 600, value = 500),
        sliderInput
